...
const delayedContainerVariants = (duration = 0.5, delay = 0.5) => ({
      ...
      <div className=" lg:mt-36 lg:mb-24 md:mt-20 md:mb-20 mt-10 mb-10 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="grid grid-rows-1 md:grid-rows-2 gap-11 position: relative">
          ...
          <motion.div
            ...
            variants={delayedContainerVariants(0.5,0)}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
          >
            ...
            >
              ...
              <h1 className="text-blue-950 text-2xl md:text-3xl lg:text-4xl font-bold mb-4">
                AI Features
              </h1>
            </motion.div>
            <motion.p
              className="text-blue-950 w-[70%] md:w-[80%] lg:w-[80%] text-center"
            >
          ...
          <div className="absolute bg-blue-400 h-1 w-3/4 md:w-1 md:h-full lg:w-1 lg:h-full left-[10%] bottom-[-48%] md:bottom-[0%] lg:bottom-[0%] lg:left-[100%] md:left-[100%]"></div>

          <div className="absolute bg-blue-400 h-1 w-3/4 left-[10%] bottom-[-3%] lg:bottom-[41%] lg:left-[115%] md:bottom-[41%] md:left-[115%]"></div>

          <motion.div
            className="flex flex-col items-center justify-center"
            variants={delayedContainerVariants(0.5,0.5)}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
          >
        ...
        <div className="lg:mt-24 md:mt-24 grid grid-rows-1 md:grid-rows-2 gap-11">
            ...
            <motion.div
            className="flex flex-col items-center justify-center"
            variants={delayedContainerVariants(0.5, 0.9)}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
          >
            ...
            <motion.p
              className="text-blue-950 w-[70%] md:w-[80%] lg:w-[80%]"
          ...
          <motion.div
            className="flex flex-col items-center justify-center"
            variants={delayedContainerVariants(0.5, 1.5)}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
          >
